...
public class AExcellentGrade implements Attribute<Optional<Double>> {
    private final AttributeRepository attributeRepository;

    @Override
    public Optional<Double> getAttributeValue(Context context) {
        Optional<bg.tu_varna.sit.entity.Attribute> attribute = attributeRepository.find("name", AExcellentGrade.class.getSimpleName()).firstResultOptional();
